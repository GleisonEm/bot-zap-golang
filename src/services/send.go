...
func (service serviceSend) SendText(ctx context.Context, request domainSend.MessageRequest) (response domainSend.GenericResponse, err error) {
	...
	// Reply message
	fmt.Println("ReplyMessageID", request.ReplyMessageID, proto.String(dataWaRecipient.String()), proto.String(request.Message))
...
func (service serviceSend) SendMessage(
	...
	// 	return nil, err
	// }
	if sendMessageParams.Message != "" {
		msg = &waProto.Message{Conversation: proto.String(sendMessageParams.Message)}
	}
