...
import (
	...
	"github.com/GleisonEm/bot-claudio-zap-golang/contexts"
	"github.com/GleisonEm/bot-claudio-zap-golang/internal/rest"
	"github.com/GleisonEm/bot-claudio-zap-golang/internal/rest/helpers"
	"github.com/GleisonEm/bot-claudio-zap-golang/internal/rest/middleware"
	...
	"github.com/GleisonEm/bot-claudio-zap-golang/services"
...
var rootCmd = &cobra.Command{
	...
	Long: `This application is from clone https://github.com/GleisonEm/bot-claudio-zap-golang,
...
func runRest(_ *cobra.Command, _ []string) {
	...
	contexts.InitServiceAppContext(appService, sendService, userService, messageService, groupService)
	// Rest
